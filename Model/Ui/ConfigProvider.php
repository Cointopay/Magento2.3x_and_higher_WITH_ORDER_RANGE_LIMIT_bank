 ...
 */
namespace CointopayBank\PaymentGateway\Model\Ui;
...
{
    const CODE = 'cointopaybank_gateway';
   ...
   */
    ...
    */
    ...
    const XML_PATH_DEFAULT_COIN = 'payment/cointopaybank_gateway/bank_supported_coins';
